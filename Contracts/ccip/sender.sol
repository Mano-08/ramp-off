...
contract realusdcSender is OwnerIsCreator {
    ...
    event MessageSent(
        ...
        uint256 tradeId, // The beneficiary of the staked tokens on the destination chain.
 ...
 address public _router =0xF694E193200268f9a4868e4Aa017A0118C9a8177;
address public _link=0x0b9d5D9136855f6FEc3c0993feE6E9CE8a297846;
 address _usdcToken=0x5425890298aed601595a70AB815c96711a31Bc65;
    ...
    function setReceiverForDestinationChain(
        ...
        s_receivers[16015286601757825753] = _receiver;
    }
    ...
    function setGasLimitForDestinationChain(
        ...
        s_gasLimits[16015286601757825753] = _gasLimit;
    }
    ...
    {
        address receiver =s_receivers[16015286601757825753];
